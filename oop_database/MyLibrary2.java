 ...
 * @author Acer
 */
public class MyLibrary2 extends javax.swing.JFrame {
      DefaultTableModel model; 
         LIB2 LIB2;
    
    /**
     * Creates new form MyLibrary2
     */
    public MyLibrary2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        combo1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Book's Title" }));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(BT, javax.swing.GroupLayout.PREFERRED_SIZE, 306, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MyLibrary2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MyLibrary2().setVisible(true);
            }
        });
    }
      void LoadData() {
